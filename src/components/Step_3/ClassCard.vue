<template>
  <div class="b-attachment-card b-construcor-app__main-card" @click="select_class">
    ...
    <div class="b-attachment-card__right">
      <div class="b-attachment-card__header">
        <div class="b-attachment-card__name">{{item.name}}</div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
      select_class(){
          this.$emit('select_class', parseInt(this.item.class))
      }
  }
};
</script>
